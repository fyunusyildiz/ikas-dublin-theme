...
export const FiltersWrapper = (props: FiltersWrapperProps) => {
  return (
    <div
      className={`flex col-span-1 h-full sm:col-span-4 flex-col gap-3 header-sm:gap-0 header-sm:mb-10 header-sm:last:mb-0 header-sm:last:border-b-0 border-b border-x border-solid border-[#222] header-sm:border-x-0`}
    >
