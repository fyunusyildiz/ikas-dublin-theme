...
const Detail = (props: ProductDetailProps) => {
  ...
  return (
    <div className="sticky mt-5 no-scrollbar sm:mt-0 col-span-6 h-[calc(100vh-96px)] overflow-y-auto sm:h-fit pr-[30px] sm:top-0 top-24 md:top-24 overflow-x-hidden sm:px-5 xs:px-3">
